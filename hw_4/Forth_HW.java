...
public class Forth_HW {
    ...
    /* MAIN TASK:
    Add the 4th player Medic who has the ability to heal after each round for an N amount
   ...
   but takes damage from the Boss*/
    ...
    /*  ADDITIONAL TASK:
    1) Add the nth player Golem, who has an increased life but a weak hit. Can take 1/5 part
    ...
    Thus, bossDamage to Golem will be 120 (while there are 8 players in the game), and  40 to others */
